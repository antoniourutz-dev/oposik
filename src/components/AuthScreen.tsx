        ...
        >
          ...
          <div className="overflow-hidden rounded-[2.8rem] border border-white/10 bg-white/5 p-1 shadow-2xl backdrop-blur-3xl">
              ...
              <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] font-black uppercase tracking-[0.16em] text-slate-400">Portal oficial v2.4</p>
                  </div>
                </div>
                  ...
                  >
                    <form onSubmit={handleSubmit} className="space-y-5">
                      <div className="space-y-2">
                        <span className="text-[10px] font-black uppercase tracking-[0.18em] text-slate-400 ml-1">Identificador</span>
                        <div className="group relative">
                          <UserRound size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-slate-950 transition-colors" />
                          <input 
                            value={username}
                      ...
                      <div className="space-y-2">
                        <span className="text-[10px] font-black uppercase tracking-[0.18em] text-slate-400 ml-1">Contraseña</span>
                        <div className="group relative">
                          <Lock size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-slate-950 transition-colors" />
                          <input 
                      ...
                      {error && (
                        <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="p-4 rounded-2xl bg-rose-50 border border-rose-100 text-[13px] font-bold text-rose-600">
                          {error}
                        </motion.div>
                      )}
                  ...
                  >
                    <div className="p-6 rounded-3xl bg-indigo-50 border border-indigo-100">
                       <div className="flex items-center gap-2 mb-3">
                          ...
                          <span className="text-[10px] font-black uppercase tracking-widest text-indigo-500">Invitación de cortesía</span>
                       </div>
                       <p className="text-sm font-bold text-slate-700 leading-relaxed">
                         Prueba la experiencia de examen real hoy. Tienes <span className="text-indigo-600 font-extrabold">{guestBlocksRemaining} bloques</span> disponibles sin registro.
                       </p>
                    </div>
                    ...
                    <p className="text-center text-[10px] font-bold text-slate-400 uppercase tracking-widest">El progreso de invitados no es persistente</p>
                  </motion.div>
                )}
              </AnimatePresence>
            </div>
            ...
            <div className="p-6 flex justify-center gap-2 items-center">
               ...
               <p className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">Protección SSL Nivel Bancario Activa</p>
               <span className="h-1 w-1 rounded-full bg-slate-400" />
            </div>
          </div>
