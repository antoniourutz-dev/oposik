  ...
  "rounded-[1.5rem] border transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        glass: 
          "backdrop-blur-md border-white/40 bg-white/70 shadow-[0_8px_32px_0_rgba(31,38,135,0.07)]",
        premium:
        ...
        colored:
          "border-[#c8d8fb]/70 bg-[linear-gradient(135deg,#72afe6_0%,#87a6ee_56%,#8d96f4_100%)] text-white shadow-[0_22px_52px_-42px_rgba(141,147,242,0.22)]",
      },
      p: {
        none: "p-0",
        sm: "p-3",
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "text-lg font-black leading-none tracking-tight text-slate-900 border-none",
      className
    )}
    {...props}
  />
